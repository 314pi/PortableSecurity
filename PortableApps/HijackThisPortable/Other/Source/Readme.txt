...
user in an INI file next to HijackThisPortable.exe called HijackThisPortable.ini.
...
copy AppNamePortable.ini from this directory to HijackThisPortable.ini next to
HijackThisPortable.exe. The options in the INI file are as follows:
